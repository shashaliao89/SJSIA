...
export default function AboutPage() {
  return (
    <div className="text-white">
      <section className="relative overflow-hidden bg-gradient-to-b from-[#00332B] via-[#002a24] to-[#001f1c] px-6 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-6xl">
          <p className="mb-4 text-xs font-black tracking-[0.35em] text-[#D0FF00]/80">
            關於協會
          </p>
          <h1 className="text-4xl font-black leading-tight md:text-6xl">
            盛家運動健康產業協會{" "}
            <span className="text-[#D0FF00]">SJSIA</span>
          </h1>
